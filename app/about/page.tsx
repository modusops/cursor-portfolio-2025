...
export default function About() {
  ...
  w-max md:w-[90%] lg:w-1/2">
          <Link href="/">
            <h1 className="text-m font-light text-black dark:text-white font-sans pl-2 drop-shadow-sm hidden md:block hover:opacity-80 transition-opacity cursor-pointer">Dave Chan</h1>
          </Link>
          <div className="flex items-center space-x-4">
            <Link
              href="/"
              className="nav-item px-5 py-2 text-black/90 dark:text-white/90 hover:text-black dark:hover:text-white rounded-full transition-all text-sm font-light relative hover:bg-black/10 dark:hover:bg-white/20 backdrop-blur-sm border border-transparent hover:border-black/20 dark:hover:border-white/20 drop-shadow-sm"
            >
              Home
            </Link>
            <Link
              href="/about"
              className="nav-item active px-5 py-2 rounded-full bg-black dark:bg-white backdrop-blur-sm text-white dark:text-black text-sm font-light transition-all duration-200 relative border border-black dark:border-white hover:bg-gray-800 dark:hover:bg-gray-100 hover:border-gray-800 dark:hover:border-gray-100 drop-shadow-sm"
            >
              About
            </Link>
            <Link
