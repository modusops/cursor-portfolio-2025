          ...
          <div className="prose max-w-none text-lg dark:prose-invert transition-colors duration-200">
            ...
            <ul className="space-y-6">
              <li>
                ...
                <div className="text-gray-600 dark:text-gray-400 transition-colors duration-200">LTK, 2023-Present</div>
              </li>
              <li>
                <div className="font-medium text-black dark:text-white transition-colors duration-200">
              ...
              <li>
                ...
                <div className="text-gray-600 dark:text-gray-400 transition-colors duration-200">Adobe, 2019-2021</div>
              </li>
            </ul>
          </div>
        </div>
