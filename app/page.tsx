          ...
          >
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-16 stagger-children">
                {/* Social Links */}
                <div>
                  <div className="flex flex-col lg:grid lg:grid-cols-3 gap-y-8">
                    <a
                    ...
                    <a
                      href="https://github.com/DaveChan-ux?tab=repositories"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors"
                    >
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-[200] text-black dark:text-white transition-colors duration-200 font-sans" style={{ fontWeight: 200, letterSpacing: "-0.01em" }}>
                    <TypewriterText 
