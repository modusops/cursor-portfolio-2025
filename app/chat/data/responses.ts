export const responses = {
  ...
  "can-i-see-your-resume": "You can download my resume by clicking the 'Download Resume' button in the Experience section on the home page. It includes my full work history, skills, and experience across various companies and projects.",
  "examples-of-work": "I've worked on several notable projects including LTK Creator (helping creators understand their business), LTK Chat (building stronger creator-led communities), Lighten AI (using AI for real-time patient insights), and Sono (building the future of knowledge management). You can explore detailed case studies for these projects in the Projects section of my portfolio.",
} as const
