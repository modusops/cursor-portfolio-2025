...
export default function CaseStudyLTKDashboard() {
  ...
  // Projects array - excluding current project (creator)
  const projects = [
    {
      title: "LTK Chat",
                      ...
                      <div className="flex flex-col gap-6 stagger-children">
                        {projects.map((project) => {
                          return (
                            ...
                            >
                              <Link href={project.slug === "ltk-chat" ? "/case-study-ltk-chat-design" : project.slug === "lighten" ? "/project-lighten-design" : `/projects/${project.slug}`} className="flex flex-col h-full">
